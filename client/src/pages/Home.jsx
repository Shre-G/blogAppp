...
export default function Home() {
    const [offerBlogs, setOfferBlogs] = useState([]);
    ...
    const [saleBlogs, setSaleBlogs] = useState([]);
    const [rentBlogs, setRentBlogs] = useState([]);
    SwiperCore.use([Navigation]);
    console.log(saleBlogs);
    console.log(offerBlogs);
        ...
        <div>
            ...
            <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
                <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl'>
                    Write your next <span className='text-slate-500'>engaging</span>
                    <br />
                    Blog with ease
                </h1>
            ...
            <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
                ...
                {travelBlogs && travelBlogs.length > 0 && (
                    <div className="my-3">
                        <div className="">
                            <h2 className='text-2xl font-semibold text-slate-600'>Recent Travel Blogs</h2>
                ...
                {technologyBlogs && technologyBlogs.length > 0 && (
                    <div className="my-3">
                        <div className="">
                            <h2 className='text-2xl font-semibold text-slate-600'>Recent Tech Blogs</h2>
                            <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=rent'}>
                ...
                {foodBlogs && foodBlogs.length > 0 && (
                    <div className="my-3">
                        <div className="">
                            <h2 className='text-2xl font-semibold text-slate-600'>Recent Food Blogs</h2>
                            <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=rent'}>
                ...
                {lifestyleBlogs && lifestyleBlogs.length > 0 && (
                    <div className="my-3">
                        <div className="">
                            <h2 className='text-2xl font-semibold text-slate-600'>Recent Lifestyle Blogs</h2>
                            <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=rent'}>
