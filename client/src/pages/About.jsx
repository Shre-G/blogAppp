...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700'>Writify is a leading blogging website that specializes in providing you the best reading and writing experience. Whether you want to gain insights on topic , want to explre information or just want to share you invaluable and exciting experiences, Writify caters to all your needs.</p>
